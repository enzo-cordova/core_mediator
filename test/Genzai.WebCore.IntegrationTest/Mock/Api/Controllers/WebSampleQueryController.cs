...
namespace Genzai.WebCore.Integration.Test.Mock.Api.Controllers
{
    ...
    [Tags("Sample")]
    public class WebSampleQueryController : BaseQueryController
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="mediator"></param>
        public WebSampleQueryController(IMediator mediator) : base(mediator, SampleConstants.ControllerSamples)
        {
        }
